...
?>
 ...
 <div id="content">
			...
			<div id="profile_content">
				<h1 class="inner_title"><span>Cricket Profile</span>   <a href="<?php echo $general->url;?>/ajax/cricket_profile.php" class="edit">Edit</a></h1>
				<?php $auth->showMsg();?>
			  <div id="profile_content_inner">
			  <?php include('ajax/cricket_profile_view.php');?>
			  </div>
			</div>
			<div class="clr"></div>
 </div>
